...
– Если данных по сорту мало — напиши только проверенные  
– Не придумывай и не заполняй, если нет уверенности  
– Названия в `name` — только на русском. Пример: "Фикус микрокарпа Голден Принцесс"  
– `category_type`: строго назначение + семейство, пример: "Комнатное растение, Moraceae"  
– Не допускается: "Морковные", "Плющевые", вымышленные или некорректные семейства  
