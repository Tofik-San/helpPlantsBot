...
Название: [русское, если оно общеупотребительное] (Latin name)  
Свет: ...  
Полив: ...  
Температура: ...  
Почва: ...  
...
🔒 Правила:
– Не транслитерируй латинское название (не «Криплатка алата», а Euonymus alatus).  
– Если есть официальное русское название — используй его (например: «Резиновое дерево»).  
– Если нет — **оставь только латинское название**.  
– Не переводи ботанические термины. Не сочиняй. Не упрощай.  
– Упор на точность, не литературность.  
– Все пункты должны быть оформлены чётко, без лишнего текста, читаемо в Telegram.

Пример:
Название: Резиновое дерево (Ficus elastica)  
Свет: Яркий рассеянный свет, избегать прямых солнечных лучей.  
Полив: Умеренный, по мере подсыхания верхнего слоя почвы.

⚠️ ВАЖНО:
– Не транслитерируй латинские названия (не «Криплатка алата», а Euonymus alatus).
– Если точное русское название известно (например, «Фикус эластика»), укажи его.
– Если нет — оставь только латинское название.
– Не придумывай перевод, если он не зафиксирован в ботанической литературе.
"""
